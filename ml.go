...
var (
    project = "around-314619" 
    url = "https://us-central1-aiplatform.googleapis.com/v1alpha1/projects/" + project + "/locations/us-central1/endpoints/7292506473177808896:predict"
...
func annotate(r io.Reader) (float64, error) {
    ...
    if len(resp.Predictions) == 0 {
        ...
        // Sometimes it's due to the image format. Google only accepts jpeg don't send png or others. fmt.Printf("failed to parse response %s\n", string(body))
